...
import { OdeteLogoBubble } from './components/OdeteLogos';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex items-center justify-center">
        <div className="text-center">
          <div className="w-20 h-20 rounded-3xl overflow-hidden mx-auto mb-4 shadow-lg animate-pulse">
            <OdeteLogoBubble size={80} />
          </div>
